package com.chandan.vecaptchatest.captcha;
...
public class GenerateCaptcha extends CaptchaController {
	...
	public GenerateCaptcha(int width, int height, MathOptions opt){
		this.height = height;
    	setWidth(width);
    	this.options = opt;
